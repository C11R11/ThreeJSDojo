...
class App {
    constructor(port) {
        ...
        app.use('/jsm/utils/SceneUtils', express_1.default.static(path_1.default.join(__dirname, '../../node_modules/three//examples/jsm/utils/SceneUtils.js')));
        app.use('/jsm/geometries/DecalGeometry', express_1.default.static(path_1.default.join(__dirname, '../../node_modules/three//examples/jsm/geometries/DecalGeometry.js')));
