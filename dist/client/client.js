...
const camera1 = new THREE.PerspectiveCamera(75, 1, 0.1, 20);
const camera2 = new THREE.OrthographicCamera(-10, 10, 10, -10, 0.1, 200);
const camera3 = new THREE.PerspectiveCamera(75, 1, 0.1, 200);
