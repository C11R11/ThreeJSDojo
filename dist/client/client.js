...
const camera2 = new THREE.OrthographicCamera((frustumSize * aspect) / -2, (frustumSize * aspect) / 2, frustumSize / 2, frustumSize / -2, 0.1, 30);
const camera3 = new THREE.OrthographicCamera(-50, 50, 50, -50, 0.1, 500);
